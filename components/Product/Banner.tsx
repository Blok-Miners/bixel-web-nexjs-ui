  ...
  return (
    <div className="relative flex aspect-square h-full w-full items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-4 left-10 flex items-center gap-4">
        <div className="relative h-[100px] w-[100px] overflow-hidden rounded-full border-2 border-white bg-th-black">
          <Image
            className="h-full w-full object-cover"
            src={logo}
            alt="Banner"
        ...
        <div className="flex flex-col gap-2 text-3xl font-bold uppercase">
